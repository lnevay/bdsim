...
void Element::PublishMembers()
{
  ...
  publish("rmat15",     &Element::rmat15);
  publish("rmat16",     &Element::rmat16);
  publish("rmat21",     &Element::rmat21);
  publish("rmat22",     &Element::rmat22);
  publish("rmat23",     &Element::rmat23);
  publish("rmat24",     &Element::rmat24);
  publish("rmat25",     &Element::rmat25);
  publish("rmat26",     &Element::rmat26);
  publish("rmat31",     &Element::rmat31);
  publish("rmat32",     &Element::rmat32);
  publish("rmat33",     &Element::rmat33);
  publish("rmat34",     &Element::rmat34);
  publish("rmat35",     &Element::rmat35);
  publish("rmat36",     &Element::rmat36);
  publish("rmat41",     &Element::rmat41);
  publish("rmat42",     &Element::rmat42);
  publish("rmat43",     &Element::rmat43);
  publish("rmat44",     &Element::rmat44);
  publish("rmat45",     &Element::rmat45);
  publish("rmat46",     &Element::rmat46);
  publish("rmat51",     &Element::rmat51);
  publish("rmat52",     &Element::rmat52);
  publish("rmat53",     &Element::rmat53);
  publish("rmat54",     &Element::rmat54);
  publish("rmat55",     &Element::rmat55);
  publish("rmat56",     &Element::rmat56);
  publish("rmat61",     &Element::rmat61);
  publish("rmat62",     &Element::rmat62);
  publish("rmat63",     &Element::rmat63);
  publish("rmat64",     &Element::rmat64);
  publish("rmat65",     &Element::rmat65);
  publish("rmat66",     &Element::rmat66);
