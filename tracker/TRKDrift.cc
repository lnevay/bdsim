...
//TRKDrift::TRKDrift() {}
TRKDrift::TRKDrift(TRKTrackingElement::TRKType typeIn, int trackingSteps, std::string nameIn, double lengthIn, 
		   TRKAperture *apertureIn, TRKPlacement *placementIn) :
  TRKTrackingElement(typeIn, trackingSteps, nameIn,lengthIn, apertureIn, placementIn)
{
}
